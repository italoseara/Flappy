...
class Keyboard:
    ...
    def update(cls, events):
        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                cls.pressed_in_frame[pygame.KEYDOWN].append(event.key)
            elif event.type == pygame.KEYUP:
                cls.keys[event.key] = None
                cls.pressed_in_frame[pygame.KEYUP].append(event.key)
    ...
    @classmethod
    def get_pressed_in_frame(cls, type, key):
        return key in cls.pressed_in_frame[type]
